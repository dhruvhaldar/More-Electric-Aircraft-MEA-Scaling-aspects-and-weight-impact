...
\makeglossaries
\input{MEAacronyms.tex}                %load the acronyms file
...
\todo[inline, backgroundcolor=aqua]{cite ironpython code}
...
\lstinputlisting[caption={Iron Python Code for climb case study}, label=dhruvpythoncode1]{IPS/IronPython1.tex}


\lstinputlisting[caption={Sample Iron Python Code block for meshing}, label=dhruvpythoncode2]{IPS/IronPython2.tex}
